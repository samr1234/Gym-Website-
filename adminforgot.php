...
$sql="UPDATE `adminsignup` SET `email`='$email',`password`='$password' WHERE email='$email'";
$query=mysqli_query($conn,$sql);
if($query){
    echo '<script> alert("you password has been reset");  location.replace(document.referrer);</script>';
}
...
<body>
    ...
    <div class="con">
        ...
        <form action="adminforgot.php" name="loginform" method="POST" onsubmit="return validateLoginForm()" >
